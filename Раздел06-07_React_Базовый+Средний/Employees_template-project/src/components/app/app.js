...
class App extends Component {
  constructor(props) {
    ...
    this.state = {
      data: [
        {name: 'Nika K.', company: 'Schkola', salary: 800, increase: true, rise: true, id:1},
        {name: 'Nastya K.', company: 'Salon Sharm', salary: 3000, increase: false, rise: false, id:2},
        {name: 'Dima Kab.', company: 'Karcher', salary: 5900, increase: true, rise: false, id:3}
      ],
  ...
  render() {
    // Lesson 138
    const {data, term, filter, corporation} = this.state;
    ...
    return (
      <div className="app">
          <AppInfo
          employees={employees} increased={increased} corporation={corporation}
          />
