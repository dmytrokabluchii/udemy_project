...
const BootstrapTest = (props) => {
    return (
        // Добавим Bootstrap-отступы контейнеру
        <Container className='mt-5 mb-5'>
          ...
          <Row>
            <Col>
                {/* Вставим какое-то св-во left(этот пропс будет находиться в App.js), 
                т.е. вставим левую колонку и еще ниже правую и далее импор-м его в App.js */}
                {props.left}
                {/* <Form>
            ...
            {props.right}
                {/* <Carousel>
                    <Carousel.Item>
                        ...
                        src="https://images.unsplash.com/photo-1666214280557-f1b5022eb634?ixlib=rb-4.0.3&ixid=MnwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80"
                        alt="First slide"
                        />
                        <Carousel.Caption>
