...
// Активировать при работе с порталами, из Lesson 160
// import AppPortals from './AppPortals';

// Импортируем компонент со стилями из App.js и далее ее можно испол-ть в файле
import {Button} from './App';
import styled from 'styled-components';

// import BootstrapTest from './BootstrapTest';
// Подключаем стили библиотеки bootstrap
import 'bootstrap/dist/css/bootstrap.min.css';


// Если мы к компонету Button хотим добавить др-е стили, мы можем их наследовать от др-го компонета
...
root.render(
  ...
  <StrictMode>
    ...
    {/* <Button/> */}
    {/* <BigButton>+++</BigButton>*/}
    {/*Если нам нужно изменить тег элементу испол-т атрибут: as  */}
...
// Установка Styled Components: npm install --save styled-components

// Установка bootstrap-react
