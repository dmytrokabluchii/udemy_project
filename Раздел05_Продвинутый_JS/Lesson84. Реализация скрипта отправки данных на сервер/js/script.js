...
window.addEventListener('DOMContentLoaded', () => {
    ...
    // берем все наши формы и под каждую из них подвяз-м фун-ю postDate. Объект FormData имеет метод forEach
    forms.forEach(item => {
        ...
        form.addEventListener('submit', (e) => {
            ...
            request.addEventListener('load', () => {
                if (request.status === 200) {
                    ...
                    statusMessage.style.cssText = 'color: green; font-size: 20px';
