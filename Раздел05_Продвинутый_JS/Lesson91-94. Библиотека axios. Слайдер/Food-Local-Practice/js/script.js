...
window.addEventListener('DOMContentLoaded', () => {
    ...
    // Lesson 90 Есть еще 2-й альтернативный вариант создания динамических элементов на стр-це
    ...
    arrowNext.addEventListener('click', () => {
        ...
        // Метод slice() извлекает часть строки, где в () мы укажем позицию для извлечения от и до
    ...
    dots.forEach(dot => {
        dot.addEventListener('click', (e) => {
            ...
            // где +width.slice(0, width.length - 2) - общая ширина при расчете
    ...
    // // Далее проинициализируем нашу фун-ю показа слайдера ниже со значением внутри
    ...
    //     totalSliderCounter.textContent = slides.length;
    // }
    // // Фун-я показа слайда, в n будет приходить slideIndex
    // function showSlides(n) {
    //     // Установим гранич-е значения слайда, когда мы перем-ся от 1 до посл-го слайда и обратно
    //     // Если slideIndex(n) больше чем кол-во слайдов в нашем слайдере, то знач-е будет = 1
    //     if (n > slides.length) {
    //         slideIndex = 1;
    //     }
    //     // Если слайдер уходит в отриц-е значения или 0, то lideIndex будет в посл. елементе слайдера
    //     if (n < 1) {
    //         slideIndex = slides.length;
    //     }
    //     // Сначала скрываем все слайды
    //     slides.forEach(item => item.style.display = 'none');
    //     // далее показываем только текущий слайд, - 1 т.к. 1-й слайд у нас 0 в массиве
    //     slides[slideIndex - 1].style.display = 'block';
    //     // Отображение текущего слайда в счетчике
    //     if (slides.length < 10) {
    //         // .textContent - Позволяет задавать или получать текстовое содержимое элемента и его потомков.
    //         // где slideIndex это наш текущий слайд
    //         currentSliderCounter.textContent = `0${slideIndex}`;
    //     } else {
    //         currentSliderCounter.textContent = slideIndex;
    //     }
    // }
    // // Разделим обязанности, в этой фун-и будет убав-ся или добавл-я индекс с кол-ом слайдов
    // function plusSlides(n) {
    //     // далее мы просто вызыв-м фун-ю showSlides с необ-м числом
    //     showSlides(slideIndex += n);
    // }
    // // При нажатии на соот-е кнопки мы будем убавлять или добавлять слайд
    // arrowPrev.addEventListener('click', () => {
    //     plusSlides(-1);
    // });
    // arrowNext.addEventListener('click', () => {
