...
function forms(formSelector, modalTimerId) {
    ...
    function bindPostData(form) {
        ...
        form.addEventListener('submit', (e) => {
            ...
            (0,_services_services__WEBPACK_IMPORTED_MODULE_1__.postDada)('http://localhost:3000/requests', json)
...
/* harmony export */   "postDada": () => (/* binding */ postDada)
/* harmony export */ });
...
window.addEventListener('DOMContentLoaded', () => {  
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_1__["default"])('.timer', '2022-12-08');
